...
public class bonusDNAAssignment {
	...
	public static void main(String[] args) throws IOException, FileNotFoundException {
        ...
        System.out.println("\nTo fulfill the purpose of the program, you can now input a file containing one-half of a DNA double helix.");
    	...
    	// Get file name from user input
  		...
  		String fullStrand = "";
  		// Process each line of the file to be added to a singular string
  			while (fileIn.hasNextLine()) {
  				String line = fileIn.nextLine();
  				//every line in the file is to be added to a singular string
  				fullStrand += line;
  			} 
  			outputFile.close();
  			
  		//file's contents compiled into a singular string
  		fullStrand = fullStrand.toUpperCase();
  		
  		// Calling the findAllProteins method to find all possible proteins that can be constructed from the DNA strand
        String[] proteins = findAllProteins(fullStrand);
	...
	public static String findComplement (String s) {
		// Create a String to store the complement of the DNA strand
		String newWord = "";
	...
	public static String findRNAStrand (String s) {
		...
		// Create a String to store the RNA strand
		String newWord = "";
	...
	public static String findProtein(String s) {
		// Initialize a String to hold the protein sequence
		String newWord = "";
		...
		return stopExists ? newWord : "This DNA strand does not encode any proteins."; 
	}
